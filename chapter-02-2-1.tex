...
当a>1时,记$N_1=[a]+1,\textrm{则}N_1>a$

当$n>2N_1$时

$\frac{a^n}{n!}=\frac{a}{1}\times\frac{a}{2}...\times\frac{a}{N_1}\times\frac{a}{N_1+1}...\times\frac{a}{N_1+N_1}\times\frac{a}{n}$
$\leq\frac{a^{N_1}}{N_1!}\times\frac{a}{n}$

所以取$N=max\{2N_1+1,[\frac{a^{N_1+1}}{N_1!\epsilon}]+1\}$
